...
static StringView intrinsic_function_name(Builtin value)
{
    switch (value) {
...
inline size_t intrinsic_argument_count(Builtin value)
{
    switch (value) {
...
struct Formatter<JS::Bytecode::Builtin> : Formatter<StringView> {
    ...
    {
        return Formatter<StringView>::format(builder, intrinsic_function_name(value));
    }
};
